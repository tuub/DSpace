...
<nav class="navbar navbar-default navbar-collapse" id="main-navbar">
    <div class="container">
        <a href="<%= request.getContextPath() %>/" class="navbar-brand navbar-right">
            <img src="<%= request.getContextPath() %>/image/logo-do.svg" alt="DepositOnce" class="header-logo" title="DepositOnce" style="height: 38px; padding-top: 6px;" />
        </a>
        <div class="navbar-header">
            ...
            <a href="http://www.tu-berlin.de" target="_blank" class="navbar-brand navbar-right">
                <img src="<%= request.getContextPath() %>/image/logo-tu.svg" alt="TU Berlin" class="header-logo" title="TU Berlin" style="height: 45px;" />
            </a>
        </div>
