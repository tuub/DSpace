	...
	<div class="alert alert-info"><fmt:message key="jsp.submit.show-license.info1"/></div>
        ...
        <div class="row">
             <div class="col-md-6 col-md-offset-4 btn-group">
                <input class="btn btn-danger col-md-4" type="submit" name="submit_reject" value="<fmt:message key="jsp.submit.show-license.notgrant.button"/>" />
                <input class="btn btn-success col-md-4" type="submit" name="submit_grant" value="<fmt:message key="jsp.submit.show-license.grant.button"/>" />
             </div>
        </div>
    </form>
</dspace:layout>
