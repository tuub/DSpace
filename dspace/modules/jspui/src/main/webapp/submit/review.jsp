...
<dspace:layout locbar="off" navbar="default" titlekey="jsp.submit.review.title" style="submission" nocache="true">
...
%>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3 btn-group">
                ...
                <input class="btn btn-danger col-md-4" type="submit" name="<%=AbstractProcessingStep.CANCEL_BUTTON%>" value="<fmt:message key="jsp.submit.review.button.cancelsave"/>" />
                <input class="btn btn-success col-md-4" type="submit" name="<%=AbstractProcessingStep.NEXT_BUTTON%>" value="<fmt:message key="jsp.submit.review.button.next"/>" />
            </div>
        </div>
